...
const CLIENT_ID = "504849ddc3542ad0e323";
function App() {
    ...
    <div className="App">
      {localStorage.getItem("accessToken") ? (
        <>
          ...
          <h3>Twój token jest w lokalnej pamięci :)</h3>
          <h4>Pobierz swoje dane z GitHub API</h4>
          <button onClick={getUserData}>Pobierz dane</button>
          <br />
